...
class LatestAiDevelopment():
    ...
    @agent
    def shop_keeper(self) -> Agent:
        return Agent(
            config=self.agents_config['shop_keeper'], # type: ignore[index]
            verbose=True
        )
    ...
    @task
    def shop_keeper_task(self) -> Task:
        return Task(
            config=self.tasks_config['shop_keeper_task'], # type: ignore[index]
        )
